...
class ObjectToArrayAdapterUrlSeoDataConverter
{
    ...
    public function getConverted($objectToArrayAdapter)
    {
        ...
        $this->templateProcessor->assign($objectGroup, $this->objectToArrayAdapter);
        return $this->templateProcessor->fetch('string:' .$object->getTemplateContentForUrlSeoData(), null, 'orm');
    }
