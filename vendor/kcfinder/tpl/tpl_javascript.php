<script src="<?php echo $GLOBALS['TEMPLATE_VARIABLES']['GLOBALS']['site_url'] ?>/../vendor/kcfinder/js/jquery.js" type="text/javascript"></script>
<script src="<?php echo $GLOBALS['TEMPLATE_VARIABLES']['GLOBALS']['site_url'] ?>/../vendor/kcfinder/js/jquery.rightClick.js" type="text/javascript"></script>
<script src="<?php echo $GLOBALS['TEMPLATE_VARIABLES']['GLOBALS']['site_url'] ?>/../vendor/kcfinder/js/jquery.drag.js" type="text/javascript"></script>
<script src="<?php echo $GLOBALS['TEMPLATE_VARIABLES']['GLOBALS']['site_url'] ?>/../vendor/kcfinder/js/helper.js" type="text/javascript"></script>
<script src="<?php echo $GLOBALS['TEMPLATE_VARIABLES']['GLOBALS']['site_url'] ?>/../vendor/kcfinder/js/browser/joiner.php" type="text/javascript"></script>
<script src="<?php echo $GLOBALS['TEMPLATE_VARIABLES']['GLOBALS']['site_url'] ?>/system/kcfinder/js-localize/?lng=<?php echo $this->lang ?>" type="text/javascript"></script>
