...
class ListingActivation extends EmailTemplateList
{
	protected $id = 'listing_activation';
	protected $caption = 'Notify on Listing Activation';

	public function __construct()
	{
		parent::__construct();
		$this->availableVariables[] = '$listing_sid';
