...
class RefineSearchHandler extends \apps\FrontEnd\ContentHandlerBase
{
	...
	private function getCategorySid()
	{
		...
		{
			$category_sid = \App()->Request['category_sid']['tree'][max(array_keys(\App()->Request['category_sid']['tree']))];
		}
