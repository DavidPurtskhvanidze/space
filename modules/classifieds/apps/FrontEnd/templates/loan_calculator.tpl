<div class="loanCalculator">
	...
	<div class="hint">[[Please use "$decimalSeparator" as the decimal separator.]]</div>
	<form  name="LoanCalculator" action="" >
		<table class="form">
			...
			<tr>
				<td>[[Term of Loan]]:</td>
				<td><input type="text" name="term" onkeyup="calculate(LoanCalculator, event)" class="form-control"> [[months]]</td>
			</tr>
			<tr>
				<td>[[Interest Rate]]:</td>
			...
			<tr>
				<td>[[Loan Amount]]:</td>
				<td><input type="text" name="amount" value="{$amount}" onfocus="LoanCalculator.choice[0].checked=true;LoanCalculator.choice[1].checked=false;" onkeyup="calculate(LoanCalculator, event)" class="form-control"> {$GLOBALS.custom_settings.listing_currency}</td>
			</tr>
			<tr>
				<td>[[Monthly Payment]]:</td>
				<td><input type="text" onfocus="LoanCalculator.choice[1].checked=true;LoanCalculator.choice[0].checked=false;" name="payment" onkeyup="calculate(LoanCalculator, event)" class="form-control"> {$GLOBALS.custom_settings.listing_currency}</td>
			</tr>
		</table>
	</form>
</div>
