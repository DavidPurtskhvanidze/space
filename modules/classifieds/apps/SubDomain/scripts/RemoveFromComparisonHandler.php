...
class RemoveFromComparisonHandler extends \apps\SubDomain\ContentHandlerBase
{
	...
	{
		$handler = new \modules\classifieds\apps\FrontEnd\scripts\RemoveFromComparisonHandler();
		$handler->respond();
	}
}
