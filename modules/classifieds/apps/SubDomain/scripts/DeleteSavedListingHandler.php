...
class DeleteSavedListingHandler extends \apps\SubDomain\ContentHandlerBase
{
	...
	{
		$handler = new \modules\classifieds\apps\FrontEnd\scripts\DeleteSavedListingHandler();
		$handler->respond();
	}
}
