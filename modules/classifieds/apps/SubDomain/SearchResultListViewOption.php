...
class SearchResultListViewOption implements \modules\classifieds\apps\SubDomain\ISearchResultViewTypeOption
{
	/**
	 * Search object
	...
	{
		return (\App()->Request['results_template']) ? \App()->Request['results_template'] : 'classifieds^search_results.tpl';
	}
	...
	public function getRenderedOption()
	{
		...
		return $templateProcessor->fetch('classifieds^search_result_list_view_option.tpl');
	}
