...
/**
 * Blocklist controls retrieving action interface.
 * 
 * Interface designed for retrieving actions controls for displaying in blocklist
 * 
 * @category ExtensionPiont
 */
interface IBlocklistControl
{
	/**
