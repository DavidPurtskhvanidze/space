...
/**
 * Delete language validator
 * 
 * Interface designed for validating delete language action in AdminPanel. If it returns false, language will not be deleted.
 * 
 * @category ExtensionPoint
 */
interface IDeleteLanguageValidator
{
	/**
	 * Setter of language id
