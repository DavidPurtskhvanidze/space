...
namespace modules\smarty_based_template_processor;

class Module extends \core\Module
{
	protected $name = 'smarty_based_template_processor';
	protected $caption = 'Smarty Based Template Processor';
	protected $version = '7.5.0-1';
	protected $dependencies = array('template_manager');
}
