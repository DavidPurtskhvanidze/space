...
class TemplateFactory implements \core\IService
{
	public function getTemplate($pathToTemplate, $themeName, $moduleName, $templateName)
	{
		$template = new Template();
		$template->setId("$moduleName:$themeName/$templateName");
		$template->setPathToTemplate($pathToTemplate);
		return $template;
	}
}
