...
class TemplateProcessorTitlePlugin implements IPlugin
{
	...
	{
		return array($this, "appendTitle");
	}

	public function appendTitle($params, $content)
	{
		if (empty($content)) return false;
        if ((bool)\App()->Request['do_not_modify_meta_data']) return true;
		\App()->GlobalTemplateVariable->appendPageTitle($content);
	}
}
