...
class TemplateProcessorDescriptionPlugin implements IPlugin
{
	...
	{
		return array($this, "appendDescription");
	}

	public function appendDescription($params, $content)
	{
		if (empty($content)) return false;
        if ((bool)\App()->Request['do_not_modify_meta_data']) return true;
		\App()->GlobalTemplateVariable->appendPageDescription($content);
	}
}
