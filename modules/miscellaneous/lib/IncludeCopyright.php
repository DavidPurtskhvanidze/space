...
class IncludeCopyright implements \modules\smarty_based_template_processor\lib\IPlugin
{
	...
	{
		$copyrightContent = \App()->CustomSettings->getSettingValue('copyright');
		...
		{
			return $templateProcessor->fetch('miscellaneous^copyright.tpl');
		}
