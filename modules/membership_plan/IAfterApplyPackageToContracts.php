...
/**
 * After Package To Contracts Interface
 * 
 * Interface designed for providing additional actions after package info applied to contracts.
 * 
 * @category ExtensionPiont
 */
interface IAfterApplyPackageToContracts
{
	/**
	 * Package sid setter
