...
class ListingExpirationApproachingNotification extends \modules\users\apps\FrontEnd\AbstractUserNotification
{
	public function getId()
	{
		return 'listing_expiration_approaching';
	}

	public function getCaption()
	{
		return 'Notify On Listing Expiration Date Approaching';
	}
}
