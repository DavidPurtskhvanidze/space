...
class NotWEnoughFundsToExtendContract extends \modules\main\apps\AdminPanel\EmailTemplateList
{
	protected $id = 'not_enough_funds_to_extend_contract';
	protected $caption = 'Not Enough Funds To Extend Contract';
