...
class AutoExtendCanceled extends \modules\main\apps\AdminPanel\EmailTemplateList
{
	protected $id = 'auto_extend_canceled';
	protected $caption = 'Auto Extend Canceled';
