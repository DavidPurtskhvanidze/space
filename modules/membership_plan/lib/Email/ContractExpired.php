...
class ContractExpired extends \modules\main\apps\AdminPanel\EmailTemplateList
{
	protected $id = 'contract_expired';
	protected $caption = 'Notify on Contract Expiration';
