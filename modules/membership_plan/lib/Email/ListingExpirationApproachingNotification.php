...
class ListingExpirationApproachingNotification extends \modules\main\apps\AdminPanel\EmailTemplateList
{
	protected $id = 'listing_expiration_approaching_notification';
	protected $caption = 'Listing Expiration Approaching Notification';
