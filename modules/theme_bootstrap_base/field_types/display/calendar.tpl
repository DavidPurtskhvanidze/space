{if $parameters.numberOfMonths == ''}
	{assign var=numberOfMonths value=3}
{else}
	{assign var=numberOfMonths value=$parameters.numberOfMonths}
{/if}
<span class="calendarControls">
	(<a href="{page_path id='book_listing'}?listing_sid={$listing_sid}&amp;field_sid={$field_sid}">[[Book Property]]</a>)
</span>
<div id="Calendar"></div>
