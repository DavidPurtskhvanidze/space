...
namespace modules\menu\apps\FrontEnd\scripts;

class LeftMenuBlockHandler extends \apps\FrontEnd\ContentHandlerBase
{
	protected $displayName = 'Menu';
	protected $moduleName = 'menu';
	protected $functionName = 'left_menu';

	public function respond()
	{
		$template_processor = \App()->getTemplateProcessor();
		$template_processor->display('left_menu.tpl');
	}
}
