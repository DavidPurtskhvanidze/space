<h1 class="title">[[Book $listingType $listing]]</h1>
<div class="manageCalendarPage">
    <p class="underline-hover-effect"><a href="{page_path id='listing'}{$listing_sid}">[[Back to view listing]]</a></p>
            ...
            <div class="col-md-6">
                <div class="bookListingFormWrapper">
                    ...
                    <form action="" class="bookListingForm" role="form">
                        ...
                        <button type="submit" class="default-button wb">[[Send:raw]]</button>
