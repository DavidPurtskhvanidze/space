...
namespace modules\payment_system;

class DisplayInvoiceDescription implements \modules\smarty_based_template_processor\lib\IPlugin
{
	...
	{
		return 'display_invoice_description';
	}

	public function getPluginCallback()
	{
		return array(\App()->InvoiceManager, 'displayInvoiceDescription');
	}
}
