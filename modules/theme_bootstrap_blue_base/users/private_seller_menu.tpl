...
<ul class="userMenu custom dropdown-menu-right dropdown-menu" role="menu">
    <li class="user-menu-header visible-sm visible-xs text-center">
        <span class="h5">{$GLOBALS.current_user.user_name}</span>
        <a class="logout text-right" href="{page_path id='user_logout'}" title="[[Log Out]]">
