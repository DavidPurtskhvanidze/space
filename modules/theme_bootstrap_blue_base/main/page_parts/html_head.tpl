<head>
    ...
    <link rel="stylesheet" type="text/css" href="{url file='main^component.css'}">
    <link rel="stylesheet" type="text/css" href="{url file='main^normalize.css'}">
    {includeDesignFiles}
    {includeFavicon}
    ...
    <script type="text/javascript" src="{url file="modernizr.custom.js"}"></script>
    <script type="text/javascript" src="{url file="classie.js"}"></script>
    <script type="text/javascript" src="{url file="mlpushmenu.js"}"></script>
    <script type="text/javascript" src="{url file="jquery.viewportchecker.min.js"}"></script>
</head>
