...
namespace modules\static_content\apps\MobileFrontEnd\scripts;

class ShowStaticContentHandler extends \apps\MobileFrontEnd\ContentHandlerBase
{
	...
	{
		$page_id = isset($_REQUEST['pageid']) ? $_REQUEST['pageid']: null;
		if($page_id)
		{
