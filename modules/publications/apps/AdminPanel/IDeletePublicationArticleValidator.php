 ...
 * 
 * Interface designed for validating delete publication article action in AdminPanel. If it returns false, article will not be deleted.
 * 
 * @category ExtensionPoint
 */
interface IDeletePublicationArticleValidator
{
	/**
