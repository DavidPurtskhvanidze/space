<div class="homepageMainContent">
	...
	<div class="centerBlockWrapper">
		{module name="classifieds" function="browse" category_id="root" fields="category_sid" browse_template="browse_by_categories.tpl" number_of_cols="3" do_not_modify_meta_data=true}
		{module name="classifieds" function="browse" category_id="root" fields="State" number_of_cols="3" browse_template="browse_by_state.tpl" do_not_modify_meta_data=true}
