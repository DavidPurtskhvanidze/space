...
/**
 * Base template extension point interface
 * 
 * Interface designed for displaying some data in templates through extension point.
 * 
 * @category ExtensionPoint
 */
interface ITemplateProcessorExtensionPoint
{
