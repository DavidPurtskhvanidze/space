...
class TemplateProcessorModulePlugin implements \modules\smarty_based_template_processor\lib\IPlugin
{
	...
	public function module($params)
	{
		...
		$moduleExecuter = new TemplateProcessorModuleExecute();

		if ($params['cached'])
		{
			$moduleExecuter = new TemplateProcessorModuleExecuteCached($moduleExecuter);
		}

		return $moduleExecuter->execute($params);
	}
}
