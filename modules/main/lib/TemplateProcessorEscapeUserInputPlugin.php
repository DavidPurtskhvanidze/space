...
class TemplateProcessorEscapeUserInputPlugin implements \modules\smarty_based_template_processor\lib\IPlugin
{
	...
	{
		return "escape_user_input";
	}

	public function getPluginCallback()
	{
		return array($this, "escapeUserInput");
	}

	public function escapeUserInput($value)
	{
		$converted = $value;
		\App()->ObjectMother->createHTMLTagConverterInArray()->explore($converted);
		return $converted;
	}
}
