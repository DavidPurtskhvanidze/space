...
class DisplayHtmlHeaderTagContent extends \apps\MobileFrontEnd\ContentHandlerBase
{
	...
	{
		$displayers = new \core\ExtensionPoint('modules\main\apps\MobileFrontEnd\IHtmlHeaderTagContentDisplayer');
