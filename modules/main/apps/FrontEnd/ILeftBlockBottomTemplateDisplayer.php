...
/**
 * Left block bottom template displayer interface
 * 
 * Interface designed for displaying templates after content of the left block.
 * 
 * @category ExtensionPiont
 */
interface ILeftBlockBottomTemplateDisplayer
{
	/**
