...
class DisplayHtmlHeaderTagContent extends \apps\FrontEnd\ContentHandlerBase
{
	...
	{
		$displayers = new \core\ExtensionPoint('modules\main\apps\FrontEnd\IHtmlHeaderTagContentDisplayer');
