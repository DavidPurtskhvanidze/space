...
class DisplayBodyBottomTemplatesHandler extends \apps\FrontEnd\ContentHandlerBase
{
	...
	{
		$bodyTopTemplateDisplayers = new \core\ExtensionPoint('modules\main\apps\FrontEnd\IBodyBottomTemplateDisplayer');
