...
class PasswordChangeEmail extends EmailTemplateList{
	protected $id = 'password_change_email';
	protected $caption = 'Password Change Email';

	public function __construct()
	{
		parent::__construct();
		$this->availableVariables[] = '$adminInfo';
	}
} 
