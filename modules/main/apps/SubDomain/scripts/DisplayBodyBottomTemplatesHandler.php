...
class DisplayBodyBottomTemplatesHandler extends \apps\SubDomain\ContentHandlerBase
{
	protected $displayName = 'Display Template at the Top of the Body Tag';
	protected $moduleName = 'main';
	protected $functionName = 'display_body_bottom_templates';

	public function respond()
	{
		$bodyTopTemplateDisplayers = new \core\ExtensionPoint('modules\main\apps\SubDomain\IBodyBottomTemplateDisplayer');
