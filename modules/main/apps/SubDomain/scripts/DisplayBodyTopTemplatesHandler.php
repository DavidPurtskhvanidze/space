...
class DisplayBodyTopTemplatesHandler extends \apps\SubDomain\ContentHandlerBase
{
	...
	{
		$bodyTopTemplateDisplayers = new \core\ExtensionPoint('modules\main\apps\SubDomain\IBodyTopTemplateDisplayer');
