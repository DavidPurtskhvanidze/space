<div class="contactFormPage">
	...
	<div class="contactDetailsWrapper tabularPages">
		<ul>
			<li class="tab contactDetailsTab active"><a href="#ContactDetails">[[Contact Details]]</a></li>
		</ul>
		<div id="ContactDetails" class="tabContent contactDetailsTab">
