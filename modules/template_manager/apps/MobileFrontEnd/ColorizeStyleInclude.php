...
namespace modules\template_manager\apps\MobileFrontEnd;
use modules\main\apps\MobileFrontEnd\IHtmlHeaderTagContentDisplayer;
use modules\template_manager\apps\FrontEnd\ColorizeStyleInclude as ColorizeStyleIncludeFE;

class ColorizeStyleInclude implements IHtmlHeaderTagContentDisplayer
{
	public function display()
	{
		$handler = new ColorizeStyleIncludeFE();
        $handler->display();
	}
} 
