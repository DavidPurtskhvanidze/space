...
namespace modules\template_manager\apps\FrontEnd;

use modules\main\apps\FrontEnd\IHtmlHeaderTagContentDisplayer;
...
class ColorizeStyleInclude implements IHtmlHeaderTagContentDisplayer
{
    public function display()
    {
        ...
        {
            echo '<link type="text/css" rel="stylesheet" href="' . \App()->SystemSettings->getSettingForApp('FrontEnd','SiteUrl') . '/' . $file . '" media="screen">';
        }
    }
} 
