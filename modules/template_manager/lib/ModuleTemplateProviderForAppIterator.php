...
class ModuleTemplateProviderForAppIterator extends \FilterIterator
{
	private $appId;

	public function __construct(\Iterator $iterator, $appId)
	{
	...
	{
		return in_array($this->appId, $this->current()->getAppIds());
	}
}
