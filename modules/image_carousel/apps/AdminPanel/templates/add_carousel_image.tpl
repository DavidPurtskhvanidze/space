<div class="addImageCarousel">
    <div class="breadcrumbs">
        <ul class="breadcrumb">
            <li><a href="{page_path module='image_carousel' function='manage_image_carousel'}">[[Image Carousel]]</a> &gt; [[Add a New Carousel Image]]</li>
        </ul>
    </div>
    <div class="page-content">
        <div class="page-header">
            <h1 class="lighter">[[Add a New Carousel Image]]</h1>
        </div>
