...
class DisplayCommentsHandler extends \apps\MobileFrontEnd\ContentHandlerBase
{
	...
	private function getListingForTemplate()
	{
		...
		return $listingDisplayer->wrapListing(\App()->ListingManager->getObjectBySid($this->getListingSid()));
	}
}
