...
class NewCommentAdded extends \modules\main\apps\AdminPanel\EmailTemplateList
{
	protected $id = 'new_comment_added';
	protected $caption = 'Notify on New Comment/Reply Added to your Listing';
