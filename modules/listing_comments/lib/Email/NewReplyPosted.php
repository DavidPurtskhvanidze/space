...
class NewReplyPosted extends \modules\main\apps\AdminPanel\EmailTemplateList
{
	protected $id = 'new_reply_posted';
	protected $caption = 'Notify on New Reply Posted to your Comment';
