...
class ListingReactivationActionFactory implements \core\IService
{
	public function createSynchronizeReactivationWithPackageAction($packageSid)
	{
		$action = new SynchronizeReactivationWithPackageAction();
