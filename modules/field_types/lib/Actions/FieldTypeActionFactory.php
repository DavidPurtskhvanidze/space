...
class FieldTypeActionFactory implements \core\IService
{
	/**
	 * 
	 * @return \modules\field_types\lib\Actions\FetchAutocompleteDataAction
	 */
	public function createFetchAutocompleteDataAction()
	{
		$action = new FetchAutocompleteDataAction();
		return $action;
	}
}
