	...
	<ul class="controls">
		{if $value.file_name ne null}
			<li class="removeOnFileDelete">
				<a class="itemControls watch" title="[[Watch a video:raw]]" onclick='return openLinkInWindow(this,"_blank","width=300,height=300,top=100");' href="{page_path id='video_player'}?listing_id={$listing.id}">
					[[Watch a video]]
				</a>
			</li>
			<li>
