...
<span class="ratingValueAndControl">
		{section name=stars start=1 loop=6 step=1}
			{strip}
			<a class="respondInMainWindow" title="{$smarty.section.stars.index}" href="{page_path id='rate'}?object_sid={$object_sid}&amp;object_type={$object_type}&amp;field_sid={$field_sid}&amp;rate={$smarty.section.stars.index}&amp;HTTP_REFERER={$current_page_url}" rel="nofollow">
