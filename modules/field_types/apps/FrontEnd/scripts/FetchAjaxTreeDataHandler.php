...
namespace modules\field_types\apps\FrontEnd\scripts;

class FetchAjaxTreeDataHandler extends \apps\FrontEnd\ContentHandlerBase
{
	...
	public function respond()
	{
        ...
        {
	        $res[] = array($k, $templateProcessor->fetch("string:[[{$v}]]"));
        }
