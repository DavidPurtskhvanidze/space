{if $listing_sid}
<span style="font-size:120%; font-weight:bold; color:#000;">[[Calendar]]</span>
...
{/literal}
     ...
     <br>
	<table align="left"><tr><td width="24" height="24"  class="ui-state-active"></td><td>- [[Reserved]]</td><td width="24" height="24" style="border-width:1px; border-style:solid; background:#dde8fa;"></td><td>- [[Free]]</td></tr></table>
	<br><br><br><br><a href="{page_path id='manage_calendar'}?listing_sid={$listing_sid}&field_sid={$field_sid}">[[Edit Calendar]]</a>
{else}
	<p>[[You will be able to edit the calendar after you created this listing.]]</p>
{/if}
